(define (problem hanoi)
  ...
  (:init 
   ...
   (smaller d8 d1) (smaller d7 d1) (smaller d6 d1) (smaller d5 d1) (smaller d4 d1) (smaller d3 d1) (smaller d2 d1)
   (smaller d8 d2) (smaller d7 d2) (smaller d6 d2) (smaller d5 d2) (smaller d4 d2) (smaller d3 d2)
   (smaller d8 d3) (smaller d7 d3) (smaller d6 d3) (smaller d5 d3) (smaller d4 d3) 
   (smaller d8 d4) (smaller d7 d4) (smaller d6 d4) (smaller d5 d4)
   (smaller d8 d5) (smaller d7 d5) (smaller d6 d5) 
   (smaller d8 d6) (smaller d7 d6)
   (smaller d8 d7)
