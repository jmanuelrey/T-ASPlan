...
(define (problem hard1)
  ...
  (:init
   ...
   (at t8 p1 p1) (at t2 p2 p1) (at t3 p3 p1) (at t6 p1 p2)
   (at t5 p2 p2) (blank p3 p2) (at t7 p1 p3) (at t4 p2 p3)
   (at t1 p3 p3))
  (:goal
   (and (at t1 p1 p1) (at t7 p3 p1) (at t6 p2 p3)
	(at t4 p2 p1) (at t8 p3 p2)
	(at t2 p1 p2) (at t5 p2 p2) (at t3 p1 p3)))
  )
